...
from segmentation.segmenation_inference_edgetpu import get_start_end_line, segment_gauge_needle, \
...
def read_args():
    ...
    parser.add_argument('--detection_model',
                        type=str,
                        required=False,
                        default="models/gauge_detection_model_custom_trained_saved_model_640/gauge_detection_model_custom_trained_full_integer_quant_edgetpu.tflite",
